...
module.exports = {
	...
	entry: {
		admin: path.join(ROOT_PATH, "modules/AdminModule/assets/src/admin.js"),
		bridge: path.join(ROOT_PATH, "modules/AdminModule/assets/src/bridge.js"),
	...
	plugins: [
		...
		new CopyWebpackPlugin([
			...
			{ from: path.join(ROOT_PATH, "app/assets/media"), to: "./media" }
		])
	],
	devtool: "source-map",
	performance: {
